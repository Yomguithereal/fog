...
def create_fingerprint_tokenizer(keep_digits=True, min_token_size=1,
    ...
    Args:
        keep_digits (bool): Whether to keep digits in fingerprint? Defaults
            to True.
        min_token_size (int): Minimum token size. Defaults to 1.
        split (list): List of token splitting characters.
        stopwords (iterable): List of stopwords to filter.
