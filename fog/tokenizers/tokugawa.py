...
def emoji_iter(string):
    for m in EMOJI_RE.finditer(string):
        yield m.group(0)
    ...
    def tokenize(self, string):
        ...
        while i < l:
            ...
            # Breaking punctuation apart
                ...
                if len(c) < 2 and c in PUNCT:
                    yield ('punct', c)

                else:
                    for emoji in emoji_iter(c):
                        yield ('emoji', emoji)
